...
<head>
<title>Content navigation tab - webkaran.com</title>
<style type='text/css'>
    .content {
        clear: both;
        padding: 10px;
...
<div id="tabco4">
    <ul>
        <li><a href="javascript:vd()">مدیریت سایت</a></li>
        <li><a href="javascript:vd()">مدیریت گروه ها</a></li>
        <li><a href="javascript:vd()">مدیریت خبر ها</a></li>
        <li><a href="javascript:vd()">مدیریت کاربران</a></li>
